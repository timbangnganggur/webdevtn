...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Buka Lowongan Magang</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                Input Data Lowongan Magang Baru
            </div>
                ...
                <div class="col-lg-6">
                    <form role="form" action="{{route('perusahaan.lowongan.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="nama" class="form-control" id="nama" placeholder="Judul Lowongan">
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="cp" class="form-control" id="cp" placeholder="">
                        </div>
                        <div class="form-group mb-3">
                            <label for="max_pendaftar" class="form-label">Max Pendaftar</label>
                            <input type="number" class="form-control" name="max_pendaftar" id="max_pendaftar" placeholder="">
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
