                    ...
                    <div class="row p-3">
                        <div class="col-10 m-auto">
                            ...
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                <strong>{{ session('alert-error-login') }}</strong>
                            ...
                            <div class="form-group">
                                ...
                                @if (session('alert-error-login-input') && array_key_exists('username', session('alert-error-login-input')))
                                <div class="alert alert-warning" role="alert">
                                    {{ session('alert-error-login-input')['username'][0]}}
                                </div>
                                @endif
                            </div>
                            <div class="form-group">
                                ...
                                @if (session('alert-error-login-input') && array_key_exists('password', session('alert-error-login-input')))
                                <div class="alert alert-warning" role="alert">
                                    {{ session('alert-error-login-input')['password'][0]}}
                                </div>
                                @endif
                            </div>
