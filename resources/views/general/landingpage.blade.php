...
@section('content')
 <div class="jumbotron jumbotron-fluid">
      ...
      <div class="owl-carousel owl-theme">
        <div class="item"><img class="gambar-carousel" src="img/Tips.png" alt=""><h2>Tips & Trick</h2></div>
        <div class="item"><img class="gambar-carousel" src="img/Merintis.png" alt=""><h2>Merintis Karir</h2></div>
        <div class="item"><img src="img/Kerja.png" alt=""><h2>Dunia Kerja</h2></div>
